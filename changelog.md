...
- Silverfish Scales now uncommonly drop when breaking infested blocks. Fortune increases the chance.

<br>

## 0.0.1-alpha
- Added base wearable talismans, all configurable via startup config:
